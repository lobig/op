        		...
        		<div class="row">
            		<div class="col-sm-5">
                		<div class="levanderBlushLighter rounded mb-1">
                    		<a href="../includes/product.php?itemid=' . $item['AdvertisementId'];
        if(isset($_SESSION['login']))
            echo '&login=1';
            echo '" class="image-wrapper">';
            echo '<img class="img-fluid rounded image" src="' . '/uploadedImages/babacipo.jpg' . '" class="navbar-logo"></a>
            	        </div>
                    </div>
                    <div class="col-sm-7">
                        <h5 class="m-0">
                            ...
                            if(isset($_SESSION['login']))
                                ...
                                <h5 class="small"><a href="../includes/category.php';
                                if(isset($_SESSION['login']))
                                    echo '?login=1';
