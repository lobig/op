	...
	<div class="modal-dialog ml-auto full-height max-width-100">
		<div class="modal-content border-radius-null full-height">
			...
			<div class="modal-body modal-bg p-0">
				<div class="card border-radius-null border-none">
					<div class="card-header modal-bg border-radius-null" id="headingOne">
					...
					<div id="collapse1" class="collapse modal-bg border-bottom-1px">
						<div class="card-body levanderBlushLighter border-radius-null">
				...
				<div class="card border-radius-null border-none">
					...
					<div id="collapse2" class="collapse modal-bg border-bottom-1px">
						<div class="card-body levanderBlushLighter border-radius-null">
							<div class="form-check">
				...
				<div class="card border-radius-null border-none">
					...
					<div id="collapse3" class="collapse modal-bg border-bottom-1px">
						<div class="card-body levanderBlushLighter border-radius-null">
							<div class="form-check">
				...
				<div class="card border-radius-null border-none">
					...
					<div id="collapse4" class="collapse modal-bg border-bottom-1px">
						<div class="card-body levanderBlushLighter border-radius-null">
							<div class="form-check">
